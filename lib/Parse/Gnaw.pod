...
For example, the "some" function is a shortcut to the "g" (greedy)
...
function simply passes them all directly into the "g" function.
...
"g" function, and since it is the last expression of the "some" 
subroutine, the return value of the "g" function is the return 
